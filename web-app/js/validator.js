...
var validator = (function($){
	...
	*/
	message = {
		...
		min				: 'entrada es demasiado pequeña',
		max				: 'entrada es demasiado grande',
		number_min		: 'numero pequeño',
		number_max		: 'numero muy grande',
		url				: 'url invalida',
		number			: 'no es un numero',
		email			: 'correo invalido',
		email_repeat	: 'correo no coincide',
		password_repeat	: 'contraseñas no coinciden',
		repeat			: 'repetido',
		complete		: 'completa el formulario',
		select			: 'por favor selecciona una opcion'
	};
